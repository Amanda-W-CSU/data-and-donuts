...
legend(x=20, y=190, #coordinates of where you want the legend to go 
       legend=c("Males", "Females"), #legend text label
       col=c("blue", "red"),         #colors 
       pch=15)                       #shape of legend

sessionInfo()# this will tell you the R version that you are using.
citation()# this can also be used to find the citation for the libraries that you are using e.g. citation("ggplot2")
